...
def url_expander_thread(thisTweet,numero):
    ...
    url_encoded = base64.b64encode(thisTweet["entities"]["urls"][-1]["expanded_url"])
    resp = urllib2.urlopen("http://10.10.0.250/expand.php?url=" + url_encoded)
    #print "https://sii.upa.edu.mx/expand.php?url=" + url_encoded
    str_url = resp.read()
...
if __name__ == '__main__':
    ...
    try:
        i = 0;
        for a in range(50):
            lastTweets = tweets.find({'over_expanded_url': { '$exists': False }}).limit(100)
